            ...
            NavigationView{
                ...
                .onAppear{
                    ...
                    if recipes.count == 0 {
                        ...
                        let preparationImage = UIImage(named: NSLocalizedStringFunc(key:"PreparationEng"))
                        ...
                        let ingredientImage = UIImage(named: NSLocalizedStringFunc(key:"IngredientEnglish"))
